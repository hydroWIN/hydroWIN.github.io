...
<body id="page-top" class="background-WinTiff" >
...
$stmt = sqlsrv_query($con,$sql);    
 ...
 if ($stmt) {
	 echo "Thank you for downloading Tif Viewer" . "<br>" . "Please support our efforts into creating more amazing things.";
...
?>  
                ...
                <div class="boxed-left">
					...
					<br/>
					<p>
					<h5 style="color:white;">WinTiff is a product that will help ease the pain of viewing your tif/tiff files. It offers multiple tools and will get you the results you need in a pinch. Try our WinTiff product today and let us know how you would need to get your job done and we will handle the rest. </h5>
					</p>	
					<a class="example-image-link" href="img/portfolio/Wintiff_Snapshot.jpg" data-lightbox="example-1">
					<center><img src="img/portfolio/Wintiff_Snapshot.jpg" alt="WinTiff Image" style="width:304px;height:228px;"></center>
					</a>
					<br>
						<p>
						<h4 style="color:white;">If you have any questions or if there is something that would make our applications work better for you please let us know and we will get back to you right away.</h4>
						</p>
                </div>
            </div>
	  ...
	  <form name="sentMessage" id="contactForm" method="POST">
		 <div class="boxed-right">
					...
					<div class="button-WinTiff">
						<button type="submit" class="btn btn-success btn-lg" form="contactForm" name="submit"  >DOWNLOAD FREE</button>
					</div>-
			</div>	
		</form>
		...
		<div class="row">
					...
					<!--		<div class="col-lg-12 text-center">
							<p>
							<h1 style="color:white;">GET THE FULL VERSION</h1>
							<h6 style="color:white;">Once you have placed the order, you will receive an email with your order confirmation.</h6>
							</p>
							...
							<div class="col-lg-12 text-center">
								...
								<input type="hidden" name="hosted_button_id" value="GD5VEU75QLXJA">
								
								<input type="hidden" name="on0" value="WinTiff Options">WinTiff Options<br>
								<select name="os0">
									<option value="WinTiff - No Support">WinTiff - No Support $49.99 USD</option>
									<option value="WinTiff +1 year">WinTiff +1 year $79.99 USD</option>
									<option value="WinTiff + 2 year">WinTiff + 2 year $119.99 USD</option>
								</select> 
								<br>
								<br>
