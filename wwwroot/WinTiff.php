...
$stmt = sqlsrv_query($con,$sql);    
 ...
 if ($stmt) {
	 echo "Thank you for downloading Tif Viewer" . "<br>" . "Please support our efforts into creating more amazing things.";
			...
			header('Location: /download/-_-/WinTiff-Setup.msi');
 }
	 else {
...
?>  
                ...
                <div class="boxed-left">
					...
					<br/>
					<p>
					<h5 style="color:white;">WinTiff is a Windows Application product that enables you to view your tif/tiff images. It offers multiple features out of the box and will get you the results you need in a pinch. Try our WinTiff product today and let us know what you think by emailing us at SUPPORT@WINITION.COM. </h5>
					</p>	
					...
					<br>
						<p>
						<h4 style="color:white;">If you have any questions or if you need us to support 24/7 please let us know by emailing us at support@winition.com and we will get back to you right away.</h4>
						</p>
                </div>
            </div>
