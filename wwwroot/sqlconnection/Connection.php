...
$con = mysqli_connect("localhost","MyAll","Sweets1","winition_1");
if (!$con){
	echo "Can not connect: " . mysqli_connect_error();
}


$sql = "INSERT INTO info (Name,Email,Message) VALUES ('$_POST[name]','$_POST[email]','$_POST[message]')";

 if (mysqli_query($con,$sql)) {
	 echo "Thank you" . "<br>" . "We will get back to you as quickly as possible.";
 }
	 else {
                    ...
                    <form name="sentMessage" id="contactForm" method="POST" novalidate>
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12">
                                <button type="submit" class="btn btn-success btn-lg" value="Send" name="submit" >Send</button>
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="footer-col col-md-4">
                        <h3>Location</h3>
                        <p>12012 Magazine st<br>Orlando</p>
                    </div>
                    <div class="footer-col col-md-4">
