...
<body id="page-top" class="background-WinVoice" >
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    <li class="page-scroll">
                        <a href="WINVOICE.php">WINVOICE</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
...
?>  
                ...
                <div class="boxed-left">
					...
					<br/>
					<p>
					<h5 style="color:white;">Need to streamline your invoices. Have no fear, we have what you need with to handle those pesky invoices you need to send out and keep track of. With WinVoice, you and your clients can rest happy knowing that a powerful tool has your back.</h5>
					</p>	
					<a class="example-image-link" href="img/portfolio/WinVoice_Snapshot.png" data-lightbox="example-1">
					<center><img src="img/portfolio/WinVoice_Snapshot.png" alt="WinVoice Image" style="width:304px;height:228px;"></center>
					</a>
					<br>
						<p>
	  ...
	  <form name="sentMessage" id="contactForm" method="POST">
		...
		<div class="row">
							...
							<div class="col-lg-12 text-center">
								...
								<input type="hidden" name="on0" value="WinVoice Options">WinVoice Options<br>
								<select name="os0">
									<option value="WinVoice - No Support">WinVoice - No Support $49.99 USD</option>
									<option value="WinVoice +1 year">WinVoice +1 year $79.99 USD</option>
									<option value="WinVOice + 2 year">WinVoice + 2 year $119.99 USD</option>
								</select> 
								<br>
								<br>
